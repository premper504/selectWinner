<template>
  ...
  // Función para calcular la altura de la tabla
  const calculateTableHeight = () => {
    nextTick(() => {
      ...
      if (tableTop) {
        tableHeight.value = `${windowHeight - tableTop - paginationHeight - margin}px`
      }
    })
  }
  ...
  onMounted(() => {
    ...
    calculateTableHeight() // Calcular altura inicial
