<template>
    <div class="main-body">
      ...
      <div class="maxwidth container">
        <el-table :data="winners" style="width: 100%">
          <el-table-column prop="id" label="Número de entrada" width="150" />
          <el-table-column prop="created_at" label="Fecha de Gane" width="200" />
  ...
  const subscribeToRealtime = () => {
    $supabase
      ...
      .on('postgres_changes', { event: '*', schema: 'public', table: 'ganadoresCeteco' }, (payload) => {
        ...
        fetchWinners() // Refrescamos la tabla al detectar un cambio
      })
      .subscribe()
  }
  ...
  onMounted(() => {
    ...
    subscribeToRealtime() // Activar la suscripción en tiempo real
  })
  </script>
