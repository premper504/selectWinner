...
<div style="width: 80%;"> 
  ...
  <div class="form-container">
    ...
    <div class="form-footer">
      <ElButton type="primary" @click="handleConfirm" :loading="loading">Enviar</ElButton>
    </div>
  </div>
...
const handleFileChange = (file, fileList) => {
  if (fileList.length > 1) handleRemove(fileList[0], fileList)
...
.el-upload--picture-card {
  width: 100%;
  height: 200px; /* Ajusta el tamaño si es necesario */
}

.el-upload-list--picture-card {
  width: 100%;
  height: auto; /* Para que se ajuste automáticamente */
}
...
.el-upload-list__item {
  width: 100%;
  height: auto; /* Asegúrate de que se ajuste dinámicamente */
}
