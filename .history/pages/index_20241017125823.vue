...
const spinSlotMachine = () => {
  ...
  const finalPosition = -(winnerIndex * itemHeight)

  gsap.to(namesContainer.value, {
    y: -totalDistance * 3, // Multiplicamos por 3 para asegurar suficiente scroll
    duration: totalDuration,
    ease: "power1.inOut", // Comienza y termina suavemente
    onComplete: () => {
      // Ajuste final para alinear el ganador
      gsap.to(namesContainer.value, {
        y: finalPosition,
        duration: 0.5,
        ease: "power2.out",
