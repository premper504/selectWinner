...
const showContinuousConfetti = () => {
  ...
  const frame = () => {
    confetti({
      ...
      angle: 60,
      spread: 55,
      origin: { x: 0, y: 0.3 }, // Ajustado el origen en y
      colors: colors,
      zIndex: 3000 // Asegura que esté sobre el modal
    });
    ...
    confetti({
      ...
      angle: 120,
      spread: 55,
      origin: { x: 1, y: 0.3 }, // Ajustado el origen en y
      colors: colors,
      zIndex: 3000 // Asegura que esté sobre el modal
    });
  ...
  confetti({
    particleCount: 150,
    spread: 100,
    origin: { y: 0.3 }, // Ajustado para que salga desde arriba del modal
    colors: colors,
    zIndex: 3000, // Asegura que esté sobre el modal
  });
