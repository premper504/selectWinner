...
const createConfetti = () => {
  ...
  for (let i = 0; i < confettiCount; i++) {
    ...
    // Verifica si los elementos están siendo añadidos correctamente
    console.log('Confetti creado:', confetti);
...
confetti {
  position: fixed;
  width: 15px; /* Aumentamos el tamaño */
  height: 15px; /* Aumentamos el tamaño */
  top: -10px;
  left: 50%; /* Aseguramos que aparezca cerca del centro */
  pointer-events: none;
  z-index: 9999; /* Nos aseguramos de que esté por encima de otros elementos */
  background-color: red; /* Aseguramos que tenga color visible */
